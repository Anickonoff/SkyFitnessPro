...
const Card = (props: CardProps) => {
  ...
  const tooltipText =
    courseActionState === 'added'
      ? 'Удалить курс'
      : courseActionState === 'notAdded'
        ? 'Добавить курс'
        : 'Войдите, чтобы добавить курс';

  const handleClickCourseButton = async () => {
